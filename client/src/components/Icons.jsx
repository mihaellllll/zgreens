...
// Inline action icons (sized via style prop)
...
export const PencilIcon = (p) => <I d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z" {...p} />;
export const TrashIcon  = (p) => <I d="M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2m3 0v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6h14M10 11v6M14 11v6" {...p} />;
export const PlusIcon   = (p) => <I d="M12 5v14M5 12h14" {...p} />;
export const BackIcon   = (p) => <I d="M19 12H5M12 19l-7-7 7-7" {...p} />;
export const CheckIcon  = (p) => <I d="M20 6L9 17l-5-5" {...p} />;
export const XIcon      = (p) => <I d="M18 6L6 18M6 6l12 12" {...p} />;
export const RefreshIcon= (p) => <I d="M23 4v6h-6M1 20v-6h6M20.49 9A9 9 0 005.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 013.51 15" {...p} />;
export const DownloadIcon=(p)=> <I d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3" {...p} />;
